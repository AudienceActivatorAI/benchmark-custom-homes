...
const testimonials = [
  ...
  { author: "Thomas & Maria G.", rating: 5, body: "The clarity around our budget and the written scope was what sold us. After hearing horror stories from friends whose builds went 30\u201340% over budget, having everything documented in detail gave us real peace of mind.", date: "2023-05-22", location: "Yakima Valley, WA" },
